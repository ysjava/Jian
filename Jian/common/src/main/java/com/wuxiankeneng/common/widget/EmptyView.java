...
public class EmptyView<cView extends BaseContract.View> extends LinearLayout implements PlaceHolderView {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mDrawableIds[0] = a.getInt(R.styleable.EmptyView_comEmptyDrawable, R.drawable.ic_error);
    ...
    public void triggerNetError() {
        ...
        //点击进行刷新
        if (mView != null) {
            mEmptyImg.setOnClickListener(new OnClickListener() {
                @Override
    ...
    public void setView(cView cView) {
        this.mView = cView;
    }
}
